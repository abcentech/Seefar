...
export const AnalyticsDashboard: React.FC = () => {
  return (
    <Placeholder 
        ...
        description="Access role-based business intelligence dashboards. View key metrics on platform reach, user engagement, training completion rates, and gain insights from geographical and device-based segmentation."
    />
  );
};
